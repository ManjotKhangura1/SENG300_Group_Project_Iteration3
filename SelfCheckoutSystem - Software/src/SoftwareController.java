...
public class SoftwareController {
	...
	public void SoftwareController() {
		...
		try {
			...
			RemovePurchasedItems removePurchasedItems = new RemovePurchasedItems(station, scanItem, baggingArea,
					giveChange);
	...
	public void initBarcodedItemsDatabase() throws SimulationException {
		...
		BarcodedProduct eggs = new BarcodedProduct(barcode4, "These eggs are white and brown! ",
				new BigDecimal("3.29"));
